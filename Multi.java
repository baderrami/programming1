...
public class Multi
{
    ...
    public static String times(String op1, String op2){
        String num1 = op1;
        String num2 = op2;
        ...
        String s1 = new StringBuffer(num1).reverse().toString(); //makes the string with a class "StringBuffer" and then changes the order of figures "123456789"=>"987654321"
